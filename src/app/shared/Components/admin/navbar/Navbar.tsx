...
const AdminNavbar: React.FC<NavbarProps> = ({
  ...
  subtitle = "Monitor your cargo operations and business performance",
}) => {
  ...
  return (
    <motion.header
      ...
      className="bg-white shadow-sm border-b border-gray-200 px-6 py-4 relative"
    >
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center space-x-4">
          ...
          <div className="relative">
            ...
            <input
              type="text"
              placeholder="Search shipments, clients, routes..."
              value={searchQuery}
